...
select jsonb_build_object(
  ...
  'verification_passed', state.function_matches_expected_metadata and state.authenticated_has_execute and not state.public_has_execute and not state.anon_has_execute and state.collections_index_matches_expected_definition and state.assets_index_matches_expected_definition,
