  ...
  return (
    <SiteLayout>
      ...
      <article className="container-mb pt-12 md:pt-16 max-w-3xl">
        ...
        <h1 className="mt-5 text-4xl md:text-6xl font-medium tracking-[-0.04em] leading-[1.04]">{visiblePost.title}</h1>
        ...
        <div className="mt-12 prose prose-invert max-w-none">
          <p className="text-xl text-white/75 leading-relaxed">{visiblePost.excerpt}</p>
