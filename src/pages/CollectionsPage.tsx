  ...
  return (
    <SiteLayout>
      ...
      <section className="container-mb mt-10">
        ...
        {!loading && visibleCollections.length === 0 && <div className="card-premium p-8 sm:p-10 text-center text-[#94A3B8]">No published collections yet.</div>}
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {visibleCollections.map(c => (
            <Link key={c.slug} to={`/collections/${c.slug}`} className="card-premium p-5 sm:p-8 group">
              ...
              <p className="mt-3 text-[#94A3B8]">{c.description}</p>
