  ...
  return (
    <SiteLayout>
        ...
        <div className="card-premium p-8 md:p-10 grid gap-8 md:grid-cols-[1fr_auto] items-start">
          <div>
            <div className="flex items-center gap-5">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-medium tracking-tight">{visibleCreator.name}</h1>
                <div className="mt-1 text-white/55">{visibleCreator.niche}</div>
              </div>
            </div>
          ...
          <button
            ...
            className={`rounded-full px-6 py-2.5 text-sm font-medium transition ${
              following ? "border border-white/20 bg-white/[0.06] text-white" : "bg-white text-black hover:bg-white/90"
            }`}
      ...
      <section className="container-mb mt-16">
        ...
        <p className="mt-5 max-w-2xl text-lg text-white/60">{visibleCreator.description}</p>
      ...
      <section className="container-mb mt-20">
        <h2 className="text-3xl font-medium tracking-tight">Popular assets by {visibleCreator.name}</h2>
        {loading && <div className="mt-6 card-premium p-4 text-sm text-white/55">Loading creator assets...</div>}
        {!loading && assets.length === 0 && <div className="mt-6 card-premium p-10 text-center text-white/55">No published assets yet.</div>}
      ...
      <section className="container-mb mt-28 grid gap-8 md:grid-cols-2">
        <div className="card-premium p-8">
          ...
          <p className="mt-3 text-white/60">Get every new asset, update, and playbook from {visibleCreator.name} the moment it ships.</p>
        </div>
        <div className="card-premium p-8">
      ...
      {posts.length > 0 && (
        <section className="container-mb mt-20">
          <h2 className="text-3xl font-medium tracking-tight">Posts by {visibleCreator.name}</h2>
