    ...
    >
      ...
      <div className="mt-5 flex items-start justify-between gap-3 text-xs">
        ...
        <span className={`rounded-full px-2.5 py-0.5 text-[11px] font-medium ${
          asset.price === 0
            ? "border border-[#FFD600]/25 bg-[#FFD600]/10 text-[#FFD600]"
            : "border border-[#FFD600]/25 bg-[#FFD600]/10 text-[#FFD600]"
        }`}>
      ...
      <h3 className="mt-5 text-lg sm:text-xl font-medium tracking-normal leading-snug group-hover:text-white">
        {asset.title}
      </h3>
      <p className="mt-2 text-sm text-[#CFCFCF] leading-relaxed line-clamp-3">
        {asset.description}
      </p>
      ...
      <div className="mt-6 flex items-start justify-between gap-3 border-t border-white/10 pt-5 text-xs text-[#CFCFCF] sm:items-center">
      ...
      <div className="mt-5 inline-flex items-center justify-between">
        <span className="inline-flex items-center gap-1.5 text-sm font-medium text-white/90 group-hover:text-white">
          Open asset <ArrowUpRight className="h-4 w-4 text-[#FFD600] transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
        </span>
      </div>
    </Link>
  );
