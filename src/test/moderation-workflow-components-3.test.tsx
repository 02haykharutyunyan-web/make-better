...
describe("moderation workflow component coverage", () => {
  ...
  it("updates asset filters from returned rows, ignores reload failure, and sends one request on double-click", async () => {
  ...
  it.skip("keeps mobile-width controls reachable and readable", async () => {
